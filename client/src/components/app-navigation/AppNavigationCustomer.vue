...
.customer-navigation {
  ...
  &__link {
    @apply relative flex items-center content-center justify-start h-full pl-[3.95rem] pr-6  flex items-center content-center justify-center transition-colors bg-transparent;
  ...
  &__icon {
    @apply w-6 inline-block absolute left-6 top-1/2;
